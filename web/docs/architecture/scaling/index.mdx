...
| Database circuit breaker | Process-local coordinator and worker admission that temporarily skips one unavailable database alias without changing durable routing. |
