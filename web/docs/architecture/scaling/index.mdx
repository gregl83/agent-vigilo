...
- Routed run creation, dispatch, worker processing, lease recovery, outbox
  ...
  assignment policy, and explicit shard move.
- CI coverage for the black-box multi-database route path: run creation to
  ...
  cancellation, spread-active assignment for one run, shard move,
  route-version inspection, and prerequisite-copy verification.
