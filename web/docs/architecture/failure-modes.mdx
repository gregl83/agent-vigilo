...
Healthy aliases continue through the cycle. One half-open probe is admitted
after a bounded, jittered cooldown; success closes the circuit and a repeated
availability failure increases the cooldown up to its configured maximum.
