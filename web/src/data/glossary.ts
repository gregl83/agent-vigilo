...
export const glossarySections: readonly GlossarySection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {id: 'evaluator-outcome', term: 'Evaluator outcome', definition: 'Invocation execution state: completed, error, or abstained.', scope: 'Separate from the host-derived passed or failed quality judgment.'},
      ...
      {id: 'blocking-finding', term: 'Blocking result', definition: 'Host-derived failed binding result that can fail an execution independently of its aggregate score.', scope: 'Blocking comes only from evaluator binding or dimension policy.'},
  ...
  },
  {
    ...
    entries: [
      {id: 'wit', term: 'WIT', definition: 'WebAssembly Interface Type definition used as the evaluator ABI source of truth.', scope: 'Versioned contracts live under `wit/evaluator/<version>/evaluator.wit` and become immutable when released.'},
