...
export const glossarySections: readonly GlossarySection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {id: 'evaluator-binding', term: 'Evaluator binding', definition: 'Profile entry that connects an evaluator to a dimension, weight, blocking policy, and evaluator config.', scope: 'Many bindings can apply to one case.'},
