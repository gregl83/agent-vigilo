...
export const glossarySections: readonly GlossarySection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {id: 'measurement', term: 'Measurement', definition: 'The single primary value returned by a completed evaluator invocation.', scope: 'Binary, range, normalized, or preference; the profile determines how it is normalized and judged.'},
